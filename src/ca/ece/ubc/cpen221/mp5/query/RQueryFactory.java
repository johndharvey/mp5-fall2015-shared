...
public class RQueryFactory {

    /**
     * @param string
     *            must contain a well-formed formula string of boolean literals
     *            and operators..
     * @return Formula corresponding to the string
     */
    public static RQuery parse(String string) {
        // Create a stream of tokens using the lexer.
        CharStream stream = new ANTLRInputStream(string);
        RQueryLexer lexer = new RQueryLexer(stream);
        lexer.reportErrorsAsExceptions();
        TokenStream tokens = new CommonTokenStream(lexer);

        // Feed the tokens into the parser.
        RQueryParser parser = new RQueryParser(tokens);
...
//            System.err.println("entering formula " + ctx.getText());
//        }
//
//        public void exitFormula(FormulaParser.FormulaContext ctx) {
//            System.err.println("exiting formula " + ctx.getText());
//        }
//
